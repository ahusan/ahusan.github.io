                        ...
                        <div className="space-y-2 rounded-md p-2 px-4">
                            <div className="space-y-2 text-lg font-medium leading-8">
                                ...
                                <ul className="flex space-x-5 space-y-0">
                                    ...
                                    <li>
                                        <a href={process.env.PUBLIC_URL + 'resume.pdf'} download={process.env.PUBLIC_URL + 'resume.pdf'} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-indigo-500">

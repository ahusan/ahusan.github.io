                ...
                <div>
                    <div className="flex">
                        <div className="flex flex-col">
                            ...
                            <p className="my-2 mb-10 text-white">Sorry about that! Please visit our hompage to get where you need to go.</p>
                            <a href="/" className="sm:w-full lg:w-auto border rounded-md p-4 text-center bg-indigo-600 text-white hover:bg-indigo-700">Take me there!</a>
                        </div>
                    </div>
                    <div>
                        <img src="https://i.ibb.co/G9DC8S0/404-2.png" className="w-full opacity-5 z-0" alt="404" />
                    </div>
                </div>
            </div>
            <div>
